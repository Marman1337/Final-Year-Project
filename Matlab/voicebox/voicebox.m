...
if isempty(PP)
    ...
    PP.dir_temp='C:\Users\Marcin\Dropbox\Final-Year-Project\Matlab\voicebox\TEMP';                      % directory for storing temporary files
    PP.dir_data='C:\Users\Marcin\Dropbox\Final-Year-Project\Matlab\voicebox\speech';           % default directory to preappend to speech data file names
    PP.shorten='C:\bin\shorten.exe';            % location of shorten executable
    PP.flac='C:\Users\Marcin\Dropbox\Final-Year-Project\Matlab\voicebox\flac.exe';                  % location of flac executable

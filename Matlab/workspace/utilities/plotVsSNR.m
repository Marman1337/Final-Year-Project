...
plot([20 15 10 5 0 -5 -10 -15],results{1,2}(1,:),'b');
plot([20 15 10 5 0 -5 -10 -15],results{2,2}(1,:),'r');
...
scatter([20 15 10 5 0 -5 -10 -15],results{1,2}(1,:),'.b');
scatter([20 15 10 5 0 -5 -10 -15],results{2,2}(1,:),'.r');
...
plot([20 15 10 5 0 -5 -10 -15],results{1,2}(2,:),'b');
plot([20 15 10 5 0 -5 -10 -15],results{2,2}(2,:),'r');
%plot([20 15 10 5 0 -5],results{3,2}(2,:),'g');
%plot([20 15 10 5 0 -5],results{4,2}(2,:),'m');
%plot([20 15 10 5 0 -5],results{5,2}(2,:),'k');
scatter([20 15 10 5 0 -5 -10 -15],results{1,2}(2,:),'.b');
scatter([20 15 10 5 0 -5 -10 -15],results{2,2}(2,:),'.r');

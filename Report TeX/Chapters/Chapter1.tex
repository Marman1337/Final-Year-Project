...
\item Chapter 3 describes the experimental set-up for the evaluation of VAD algorithms
\item Chapter 4 presents the evaluation results of the selected VAD algorithms
\end{itemize}